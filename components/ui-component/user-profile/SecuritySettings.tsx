        ...
        <div className="p-6 max-w-4xl mx-auto">
            ...
            >
                <div className="p-6 border-b border-neutral-200 dark:border-neutral-800">
                    <h2 className="text-xl font-semibold text-neutral-900 dark:text-white">SecuritySettings</h2>
                    <p className="text-neutral-500 text-sm mt-1">Manage your SecuritySettings settings and preferences.</p>
                </div>
                <div className="p-6 space-y-6">
                    {/* Placeholder content for SecuritySettings */}
                    <div className="h-32 bg-neutral-100 dark:bg-neutral-800 rounded-xl flex items-center justify-center border-2 border-dashed border-neutral-300 dark:border-neutral-700">
                        <span className="text-neutral-400 font-medium">SecuritySettings Content Demo</span>
                    </div>
