...
import { BiLoaderAlt, BiEnvelope, BiLockAlt, BiRightArrowAlt } from "react-icons/bi";
        ...
        <div className="flex min-h-screen bg-white dark:bg-neutral-950">
            ...
            <div className="hidden lg:flex w-1/2 relative bg-neutral-900 overflow-hidden">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent flex flex-col justify-end p-12 text-white">
                    <h2 className="text-4xl font-bold mb-4">Welcome to the Future of Content</h2>
                    <p className="text-lg text-neutral-300 max-w-md leading-relaxed">
                        Create, edit, and publish stunning blog posts with AI-powered tools and real-time collaboration.
                    </p>
                </div>
            </div>
                    ...
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        ...
                        >
                            {isLoading ? (
                                ...
                                <>
                                    Sign In <BiRightArrowAlt className="transition-transform group-hover:translate-x-1" />
                                </>
                            )}
                        </button>
                    </form>
