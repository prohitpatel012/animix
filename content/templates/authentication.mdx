...
description: Complete authentication flows including login, signup, verification, and password management.
category: Application
---

import { 
  LoginSimple, LoginSplit, LoginSocial, LoginModern, AuthCard,
  SignupSimple, SignupSplit, SignupImage,
  VerifyEmail, VerifyEmailCover,
  OTPInput, OTPVerification, TwoFactorScan,
  ForgotPasswordSimple, ForgotPasswordSplit,
  ResetPasswordSimple, ResetPasswordCover,
  ChangePasswordSimple, ChangePasswordSettings,
  LockScreen,
  // Two Factor
  TwoFactorSimple, TwoFactorSplit, TwoFactorCard, TwoFactorModern, TwoFactorGradient,
  TwoFactorImageOverlay, TwoFactorDark, TwoFactorGlass, TwoFactorMinimal, TwoFactorCorporate,
  TwoFactorBrutalist, TwoFactorNeumorphic, TwoFactorSidebar, TwoFactorLuxury, TwoFactorRetro,
  TwoFactorAbstract, TwoFactorHighContrast, TwoFactorCentered, TwoFactorPopover, TwoFactorTerminal,
  // Magic Link
  MagicLinkSimple, MagicLinkSplit, MagicLinkCard, MagicLinkModern, MagicLinkGradient,
  MagicLinkImageOverlay, MagicLinkDark, MagicLinkGlass, MagicLinkMinimal, MagicLinkCorporate,
  MagicLinkBrutalist, MagicLinkNeumorphic, MagicLinkSidebar, MagicLinkLuxury, MagicLinkRetro,
  MagicLinkAbstract, MagicLinkHighContrast, MagicLinkCentered, MagicLinkPopover, MagicLinkTerminal,
  // Logout
  LogoutSimple, LogoutSplit, LogoutCard, LogoutModern, LogoutGradient,
  LogoutImageOverlay, LogoutDark, LogoutGlass, LogoutMinimal, LogoutCorporate,
  LogoutBrutalist, LogoutNeumorphic, LogoutSidebar, LogoutLuxury, LogoutRetro,
  LogoutAbstract, LogoutHighContrast, LogoutCentered, LogoutPopover, LogoutTerminal,
  // Account Locked
  AccountLockedSimple, AccountLockedSplit, AccountLockedCard, AccountLockedModern, AccountLockedGradient,
  AccountLockedImageOverlay, AccountLockedDark, AccountLockedGlass, AccountLockedMinimal, AccountLockedCorporate,
  AccountLockedBrutalist, AccountLockedNeumorphic, AccountLockedSidebar, AccountLockedLuxury, AccountLockedRetro,
  AccountLockedAbstract, AccountLockedHighContrast, AccountLockedCentered, AccountLockedPopover, AccountLockedTerminal,
  // Suspended Account
  SuspendedAccountSimple, SuspendedAccountSplit, SuspendedAccountCard, SuspendedAccountModern, SuspendedAccountGradient,
  SuspendedAccountImageOverlay, SuspendedAccountDark, SuspendedAccountGlass, SuspendedAccountMinimal, SuspendedAccountCorporate,
  SuspendedAccountBrutalist, SuspendedAccountNeumorphic, SuspendedAccountSidebar, SuspendedAccountLuxury, SuspendedAccountRetro,
  SuspendedAccountAbstract, SuspendedAccountHighContrast, SuspendedAccountCentered, SuspendedAccountPopover, SuspendedAccountTerminal
} from '@/components/ui-component/authentication';

# Authentication

A comprehensive suite of authentication components covering the entire user lifecycle from sign up to password recovery.
...
### Split Screen Login
Features a marketing image side-by-side with the form.
...
### Social Login
Prioritizes social authentication providers.
            ...
            <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
                <div className="bg-white dark:bg-neutral-950 py-8 px-4 shadow sm:rounded-lg sm:px-10 border border-neutral-200 dark:border-neutral-800">
                    <div className="grid grid-cols-1 gap-4">
                        <button className="flex w-full justify-center items-center gap-3 rounded-md bg-[#DB4437] px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-[#c23321] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#DB4437]">
                            <BiLogoGoogle className="h-5 w-5" aria-hidden="true" />
                        ...
                        <button className="flex w-full justify-center items-center gap-3 rounded-md bg-[#1877F2] px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-[#1877F2]/90 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#1877F2]">
                            <BiLogoFacebook className="h-5 w-5" aria-hidden="true" />
                            <span className="">Continue with Facebook</span>
                        </button>
                        <button className="flex w-full justify-center items-center gap-3 rounded-md bg-[#1DA1F2] px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-[#1DA1F2]/90 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#1DA1F2]">
...
Trend-focused design with glassmorphism effects.
...
export default function LoginModern() {
    return (
        <div className="min-h-screen bg-[url('https://images.unsplash.com/photo-1481487196290-c352beb62887?q=80&w=2600&auto=format&fit=crop')] bg-cover bg-center flex items-center justify-center p-4">
...
### Auth Card (Tabs)
Switchable login and signup tabs.
...
### Split Sign Up
Registration with a dedicated marketing section.
...
### Image Cover Sign Up
Full height image paired with registration form.
...
### Simple Verification
Centered email confirmation message.
...
### Cover Verification
Split layout for verification instructions.
...
### OTP With Timer
Time-sensitive verification code input.
...
Recovery request with security tips.
...
### Reset With Requirements
Password reset with strength indicators.
    ...
    return (
        <div className="flex min-h-screen">
                    ...
                    <div className="mt-10">
                        <form action="#" method="POST" className="space-y-6">
                            ...
                            <div className="space-y-3">
                                <h4 className="text-sm font-medium text-neutral-900 dark:text-white">Password requirements:</h4>
                                <ul className="space-y-2 text-sm text-neutral-500 dark:text-neutral-400">
                                    <li className="flex items-center gap-2"><BiCheck className="text-green-500" /> Min. 8 characters</li>
                                    <li className="flex items-center gap-2"><BiCheck className="text-neutral-300" /> One special character</li>
                                    <li className="flex items-center gap-2"><BiCheck className="text-neutral-300" /> One number</li>
                                    <li className="flex items-center gap-2"><BiCheck className="text-neutral-300" /> Uppercase letter</li>
                                </ul>
                            </div>
            ...
            <div className="hidden lg:block relative w-0 flex-1">
                <img
                    className="absolute inset-0 h-full w-full object-cover"
                    src="https://images.unsplash.com/photo-1614064641938-3bcee529cfae?q=80&w=2574&auto=format&fit=crop"
                    alt=""
                />
                <div className="absolute inset-0 bg-neutral-900/10 mix-blend-multiply" />
            </div>
...
### Simple Update
Standalone password update form.
        ...
        <div className="flex min-h-screen flex-col justify-center py-12 sm:px-6 lg:px-8 bg-neutral-50 dark:bg-neutral-900">
            ...
            <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
                <div className="bg-white dark:bg-neutral-950 py-8 px-4 shadow sm:rounded-lg sm:px-10 border border-neutral-200 dark:border-neutral-800">
                    <form className="space-y-6" action="#" method="POST">
                        <div>
                            <label htmlFor="current-password" className="block text-sm font-medium leading-6 text-neutral-900 dark:text-neutral-200">
                                Current Password
                            </label>
                            <div className="mt-2">
                                <input
                        ...
                        <div>
                            <label htmlFor="new-password" className="block text-sm font-medium leading-6 text-neutral-900 dark:text-neutral-200">
                                New Password
                            </label>
                            <div className="mt-2">
                                <input
...
### Settings Panel
Change password component for settings pages.
...
export default function ChangePasswordSettings() {
    return (
        <div className="max-w-2xl mx-auto p-6 bg-white dark:bg-neutral-950 rounded-xl shadow-sm border border-neutral-200 dark:border-neutral-800">
            <h2 className="text-lg font-semibold leading-7 text-neutral-900 dark:text-white">Password</h2>
            ...
            <form className="mt-6 space-y-6">
                ...
                <div className="flex items-center justify-end gap-x-6 pt-4 border-t border-neutral-100 dark:border-neutral-800">
                    <button type="button" className="text-sm font-semibold leading-6 text-neutral-900 dark:text-white hover:text-neutral-700">
                        Cancel
                    </button>
                    <button
                        type="submit"
...
### Lock Screen
Re-authentication screen for inactive sessions.
...
export default function LockScreen() {
    return (
        <div className="flex min-h-screen items-center justify-center bg-[url('https://images.unsplash.com/photo-1550684848-fac1c5b4e853?q=80&w=2670&auto=format&fit=crop')] bg-cover bg-center">
            <div className="absolute inset-0 bg-black/40 backdrop-blur-sm" />
    
            <div className="z-10 w-full max-w-sm text-center">
                <div className="mb-8">
                    <img
                        className="mx-auto h-24 w-24 rounded-full border-4 border-white/20 shadow-xl"
                        src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80"
                        alt="User"
                    />
                    <h2 className="mt-4 text-2xl font-bold text-white">Tom Cook</h2>
                    <p className="text-neutral-200">Enter your password to unlock</p>
                </div>
                ...
                <form className="relative flex items-center">
                    <input
                        ...
                        className="w-full rounded-full border-none bg-white/10 px-6 py-4 text-white placeholder-neutral-300 backdrop-blur-md focus:ring-2 focus:ring-white/50"
                    />
                    <button
                        type="submit"
                        className="absolute right-2 rounded-full bg-white p-2 text-indigo-600 transition-transform hover:scale-105 hover:bg-neutral-100"
                    >
...
### Simple Two Factor
A clean, centered 6-digit code entry with auto-focus.
...
### Split Two Factor
Split layout with an image on the right.
...
### Card Two Factor
Simple card layout for verification.
...
### Modern Two Factor
Modern aesthetic with glassmorphism and gradient accents.
...
### Image Overlay Two Factor
Immersive background image with an overlay.

<div className="my-8 border rounded-lg overflow-hidden">
    <TwoFactorImageOverlay />
</div>
...
Dark themed verification screen.
...
### Glassmorphism Two Factor
Frosted glass effect on a colorful background.
...
### Minimal Two Factor
Extremely clean and minimal design.
...
### Abstract Two Factor
Abstract shapes and blur effects.
...
### High Contrast Two Factor
Bold, black and white high-contrast design.

<div className="my-8 border rounded-lg overflow-hidden">
    <TwoFactorHighContrast />
</div>
...
### Centered Two Factor
Simple centered layout with minimal distraction.
...
### Simple Magic Link
Clean, centered form for requesting a magic link.
...
### Split Magic Link
Split layout with feature image.
            ...
            <div className="w-full lg:w-1/2 flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-20 xl:px-24">
                <div className="mx-auto w-full max-w-sm">
                    ...
                    <form className="space-y-6">
                        ...
                        <button
                            type="submit"
                            className="flex w-full justify-center rounded-md bg-purple-600 px-3 py-2.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-purple-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-purple-600"
                        >
...
### Card Magic Link
Simple card UI for sent confirmation.
...
### Modern Magic Link
Contemporary design with gradients and glass effects.
...
### Gradient Magic Link
Vibrant gradient background style.
...
### Image Overlay Magic Link
Background image with overlay form.

<div className="my-8 border rounded-lg overflow-hidden">
    <MagicLinkImageOverlay />
</div>
...
### Glassmorphism Magic Link
Frosted glass card on a gradient.
...
### Minimal Magic Link
Super simple, large typography input.
...
### Corporate Magic Link
Professional corporate login style with sidebar information.
...
### Brutalist Magic Link
Raw, unfiltered brutalist design.
...
### Neumorphic Magic Link
Soft neumorphic design containing the form.
...
### Sidebar Magic Link
Split layout with sidebar for desktop.
...
### Luxury Magic Link
Elegant, high-end design aesthetic.
...
### Abstract Magic Link
Modern abstract design with motion effects.
...
### High Contrast Magic Link
Bold, high contrast design for accessibility and impact.

<div className="my-8 border rounded-lg overflow-hidden">
    <MagicLinkHighContrast />
</div>
...
### Simple Logout
A clean, minimal confirmation screen.
...
### Split Logout
Split layout with branding and imagery.
...
### Card Logout
Card-based logout with header graphic.
...
### Modern Logout
Modern glassmorphism logout with user avatar.
...
### Gradient Logout
Vibrant gradient background logout.
...
### Image Overlay Logout
Overlay on a background image for logout.
...
Frosted glass on colorful gradient.
...
### Minimal Logout
Typography focused minimal logout screen.
...
### Corporate Logout
Clean and professional corporate logout message.
...
### Brutalist Logout
Bold, raw brutalist style logout.
...
### Sidebar Logout
Split screen with sidebar layout.
...
### Luxury Logout
High-end, elegant gold and black theme.
...
### Retro Logout
Windows 95 style system shutdown screen.
...
### Abstract Logout
Modern abstract background with glassmorphism.
...
Bold, high contrast logout screen.
...
### Centered Logout
Simple centered logout confirmation.
...
### Popover Logout
Small popover style notification.
...
### Terminal Logout
System shutdown style terminal interface.
...
## Account Locked Screens

### Simple Locked
Minimalist account locked notification.
...
### Split Locked
Split screen design for security alerts.
...
### Card Locked
Compact card layout for locked state.
...
### Gradient Locked
Urgent gradient background alert.

<div className="my-8 border rounded-lg overflow-hidden">
    <AccountLockedGradient />
</div>
...
Locked status over a background image.

<div className="my-8 border rounded-lg overflow-hidden">
    <AccountLockedImageOverlay />
</div>
...
### Dark Locked
Dark and serious locked account warning.
...
Frosted glass effect on a dark background.
...
### Minimal Locked
Stark and direct minimal design.

<div className="my-8 border rounded-lg overflow-hidden">
    <AccountLockedMinimal />
</div>
...
### Corporate Locked
Professional locked account notice with policy info.

<div className="my-8 border rounded-lg overflow-hidden">
    <AccountLockedCorporate />
</div>
...
### Brutalist Locked
High impact brutalist warning.

<div className="my-8 border rounded-lg overflow-hidden">
    <AccountLockedBrutalist />
</div>
...
### Neumorphic Locked
Soft plastic look for security message.

<div className="my-8 border rounded-lg overflow-hidden">
    <AccountLockedNeumorphic />
</div>
...
### Sidebar Locked
Split layout with prominent image for locked state.

<div className="my-8 border rounded-lg overflow-hidden">
    <AccountLockedSidebar />
</div>
...
### Luxury Locked
High-end locked account notification.
...
### Retro Locked
Windows 95 style Security Alert.
...
### Abstract Locked
Futuristic abstract glow design.

<div className="my-8 border rounded-lg overflow-hidden">
    <AccountLockedAbstract />
</div>
...
### High Contrast Locked
Maximalist high contrast warning.

<div className="my-8 border rounded-lg overflow-hidden">
    <AccountLockedHighContrast />
</div>
...
### Centered Locked
Clean centered message with timer.

<div className="my-8 border rounded-lg overflow-hidden">
    <AccountLockedCentered />
</div>
...
### Popover Locked
Small popover notification for locked status.

<div className="my-8 border rounded-lg overflow-hidden">
    <AccountLockedPopover />
</div>
...
### Terminal Locked
Cybersecurity style terminal lockout screen.

<div className="my-8 border rounded-lg overflow-hidden">
    <AccountLockedTerminal />
</div>
...
## Suspended Account Screens

### Simple Suspended
Clear message for suspended accounts.

<div className="my-8 border rounded-lg overflow-hidden">
    <SuspendedAccountSimple />
</div>
...
### Split Suspended
Split layout for account termination.

<div className="my-8 border rounded-lg overflow-hidden">
    <SuspendedAccountSplit />
</div>
...
### Card Suspended
Profile card style for suspended users.
...
### Modern Suspended
Modern dashboard alert for suspension.

<div className="my-8 border rounded-lg overflow-hidden">
    <SuspendedAccountModern />
</div>
...
### Gradient Suspended
Vibrant gradient background for critical alerts.

<div className="my-8 border rounded-lg overflow-hidden">
    <SuspendedAccountGradient />
</div>
...
### Image Overlay Suspended
Suspension notice over a background image.

<div className="my-8 border rounded-lg overflow-hidden">
    <SuspendedAccountImageOverlay />
</div>
...
### Dark Suspended
Dark themed suspension notice.

<div className="my-8 border rounded-lg overflow-hidden">
    <SuspendedAccountDark />
</div>
...
### GlassMorphism Suspended
Suspended notice with glass effect.

<div className="my-8 border rounded-lg overflow-hidden">
    <SuspendedAccountGlass />
</div>
...
### Minimal Suspended
Clean minimal suspended notice.

<div className="my-8 border rounded-lg overflow-hidden">
    <SuspendedAccountMinimal />
</div>
...
### Corporate Suspended
Formal corporate suspension notice.

<div className="my-8 border rounded-lg overflow-hidden">
    <SuspendedAccountCorporate />
</div>
...
### Brutalist Suspended
Bold and high-contrast brutalist style notice.

<div className="my-8 border rounded-lg overflow-hidden">
    <SuspendedAccountBrutalist />
</div>
...
### Neumorphic Suspended
Soft UI design for suspended state.

<div className="my-8 border rounded-lg overflow-hidden">
    <SuspendedAccountNeumorphic />
</div>
...
### Sidebar Suspended
Suspended screen with a sidebar layout.

<div className="my-8 border rounded-lg overflow-hidden">
    <SuspendedAccountSidebar />
</div>
...
### Luxury Suspended
Elegant luxury style suspension notice.

<div className="my-8 border rounded-lg overflow-hidden">
    <SuspendedAccountLuxury />
</div>
...
### Retro Suspended
Windows 95 style error popup.

<div className="my-8 border rounded-lg overflow-hidden">
    <SuspendedAccountRetro />
</div>
...
### Abstract Suspended
Abstract background suspended screen.

<div className="my-8 border rounded-lg overflow-hidden">
    <SuspendedAccountAbstract />
</div>
...
### High Contrast Suspended
High contrast black and white suspended notice.

<div className="my-8 border rounded-lg overflow-hidden">
    <SuspendedAccountHighContrast />
</div>
...
### Centered Suspended
Simple focused centered notice.

<div className="my-8 border rounded-lg overflow-hidden">
    <SuspendedAccountCentered />
</div>
...
### Popover Suspended
Small popover style suspended notice.

<div className="my-8 border rounded-lg overflow-hidden">
    <SuspendedAccountPopover />
</div>
...
### Terminal Suspended
Command line interface style suspended screen.

<div className="my-8 border rounded-lg overflow-hidden">
    <SuspendedAccountTerminal />
</div>
