...
description: Common widgets and sections for building data-rich user dashboards.
category: Dashboard
---

import { DashboardStatsGrid, DashboardActivityFeed, DashboardUserCard, DashboardTeamTable, DashboardTasks, DashboardProjects, DashboardBilling, DashboardNotifications, DashboardCalendar, DashboardQuickActions } from '@/components/ui-component/dashboard-sections';

# Dashboard Sections

Essential building blocks for creating comprehensive and interactive user dashboards.

## Stats Grid
A responsive grid of statistic cards showing key metrics with trends.

<div className="my-8 border rounded-lg overflow-hidden bg-neutral-50 dark:bg-neutral-950 p-4">
  <DashboardStatsGrid />
</div>
...
## Activity Feed
A vertical timeline showing recent user or system actions.

<div className="my-8 border rounded-lg overflow-hidden bg-neutral-50 dark:bg-neutral-950 p-6 flex justify-center">
...
import { BiCheckCircle, BiMessageSquareA, BiCreditCard, BiUserPlus } from "react-icons/bi";
...
export default function DashboardActivityFeed() {
    const activities = [
        ...
        { id: 2, user: "Bob Jones", action: "commented on", target: "Marketing Campaign", time: "1 hour ago", icon: BiMessageSquareA, color: "text-blue-500" },
...
## User Profile Widget
A summary card displaying user details and key stats.
...
## Team Table
A clean table layout for managing team members or users.

<div className="my-8 border rounded-lg overflow-hidden bg-neutral-50 dark:bg-neutral-950 p-6">
  <DashboardTeamTable />
</div>
...
## Task List
A simple todo list with toggle states.
...
## Project Status
Card grid showing progress and deadlines for active projects.
...
## Billing Summary
A dark-themed card showing usage limits and upgrade options.
...
## Notifications Panel
Compact notification list with types (Info, Success, Warning).
...
## Mini Calendar
Interactive monthly calendar widget for dates and events.
...
## Quick Actions
Grid of prominent action buttons for common tasks.
