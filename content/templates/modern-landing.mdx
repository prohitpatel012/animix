...
<div className="border border-neutral-200 dark:border-neutral-800 rounded-xl overflow-hidden shadow-xl my-8">
  <div className="h-[600px] overflow-y-auto relative translate-x-0">
    <ModernLandingPage />
  </div>
</div>
...
<div className="border border-neutral-200 dark:border-neutral-800 rounded-xl overflow-hidden shadow-sm my-6">
  <div className="relative h-[80px] bg-neutral-100 dark:bg-neutral-900 translate-x-0">
    <Navbar />
  </div>
</div>
...
// You can use any icon library, here we use inline SVGs for portability
...
High-impact hero area with animated text and background effects.
...
A grid layout to highlight key selling points.
...
export const Features = () => {
  const features = [
    ...
    },
    {
      ...
      icon: <div className="w-6 h-6 text-white font-bold text-center leading-6">D</div>,
      color: "bg-purple-500"
    },
    {
...
A final Call to Action to convert visitors.
...
A clean footer with multiple columns.
...
Finally, bring it all together in your main page file.
